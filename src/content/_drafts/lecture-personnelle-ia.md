---
title: "Défi lecture avec l’IA : installer une lecture personnelle qui tient l’année"
...
<ul>
<li>**Un circuit de lecture papier** — une bande de progression à colorier, des paliers symboliques (« 10 titres lus »), des badges et attestations imprimables</li>
<li>**Une banque de fiches variées** — résumé en 3 phrases, dessin légendé, interview du personnage, recommandation à un camarade : chaque fiche existe en version album illustré et version chapitre</li>
<li>**Un suivi simple** — un tableau individuel papier et des rituels courts de valorisation, comme la présentation d’album en 2 minutes</li>
<li>**Une validation 100 % orale** — un livre est compté après un entretien court avec vous, jamais après un test ou une fiche toute seule</li>
<li>**Ce que l’IA ne remplace pas** — l’entretien oral avec vous : c’est lui qui valide une vraie lecture.</li>
</ul>
</div>
...
<span class="prompt-label">📋 Circuit de lecture sur mesure</span>
...
**Effectif** : [ex : 24 élèves]
**Livres disponibles** : [ex : albums et romans de la bibliothèque de classe]
...
<div class="prompt-block">
<span class="prompt-label">📋 Fiche de lecture à deux niveaux</span>
...
<div class="prompt-block">
<span class="prompt-label">📋 10 façons de raconter un livre</span>
...
<div class="prompt-block">
<span class="prompt-label">📋 Entretien de validation</span>
