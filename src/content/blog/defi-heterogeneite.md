---
title: "Défi n°2 : gérer l'hétérogénéité de la classe avec l'IA"
description: "Rythmes, lecteurs fragiles, allophones : l'IA produit les variantes d'exercices, vous gardez l'intention pédagogique et l'évaluation. Prompts inclus."
...
<span class="prompt-label">🧩 Prompt — Déclinaison en trois niveaux</span>
...
**Objectif unique** : [ex : résoudre un problème de partage équitable]
**Niveau de classe** : [ex : CE2]
**Exercice d’origine** : [coller l’exercice]
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Consigne allégée pour lecteurs fragiles</span>
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Consigne adaptée pour allophones</span>
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Grille d’observation commune</span>
...
**Compétence visée (unique pour tous)** : [ex : résoudre un problème de partage équitable]
**Critères de réussite de la séance** : [ex : choisir l’opération pertinente, justifier le résultat]
**Variantes produites** : [cœur / soutien / approfondissement / consigne allégée]
