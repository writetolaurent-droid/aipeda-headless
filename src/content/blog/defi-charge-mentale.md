---
title: "Défi n°1 : alléger la charge mentale avec l'IA (sans perdre la main)"
description: "Préparation, supports, communication : déléguez la production brute à l'IA et gardez les décisions pédagogiques. Le plan anti-débordement, prompts inclus."
category: "Préparer"
pubDate: 2026-08-28
---
...
<span class="prompt-label">📋 Prompt — Trier sa semaine d'enseignant</span>
...
1. **Tâche**
2. **Nature** : « production mécanique » (canevas répétitif, mise en forme, reformulation) ou « décision pédagogique » (choix de contenu, adaptation aux élèves, évaluation, arbitrage)
3. **Suggestion** : si mécanique → « brouillon à déléguer à l'IA » ; si pédagogique → « à traiter en priorité, décision humaine »
...
<div class="prompt-block">
<span class="prompt-label">🧭 Prompt — Trame de fiche de préparation réutilisable</span>
...
**Contexte** : [ex : classe à plusieurs niveaux / école à l'étranger / classe simple]
**Ce que je veux toujours voir apparaître** : [ex : objectif, matériel, déroulé minuté, trace écrite attendue]

La trame doit contenir :
1. **En-tête** : discipline, séance n°, durée, matériel (liste à cocher)
2. **Avant la séance** : prérequis à vérifier, préparation matérielle
3. **Pendant la séance** : déroulé en phases avec durées, modalités de travail (collectif / individuel / groupe), consignes clés
4. **Différenciation** : un champ « simplifier » et un champ « aller plus loin »
5. **Après la séance** : ce qui a fonctionné, ce qu'il faudra reprendre, suite prévue
...
<div class="prompt-block">
<span class="prompt-label">✉️ Prompt — Brouillon de compte rendu de réunion aux familles</span>
...
**Contexte** : [ex : réunion de rentrée / réunion d'information sur la sortie scolaire / point sur le fonctionnement de la classe]
**Informations à transmettre** : [lister les points en vrac, sans soigner la formulation]
**Ton souhaité** : chaleureux, concret, rassurant

Structure attendue :
1. **Objet** : une ligne claire
2. **Merci** : un court paragraphe de remerciement pour la présence
3. **L'essentiel à retenir** : 3 à 5 points en puces, sans jargon
4. **Prochaines étapes** : dates et actions attendues des familles
5. **Contact** : une phrase d'ouverture pour les questions
...
<div class="prompt-block">
<span class="prompt-label">📅 Prompt — Checklist de préparation de semaine</span>

Tu es un assistant organisé pour professeur des écoles. Crée ma checklist de préparation pour la semaine prochaine.

**Niveau / contexte** : [ex : CE1 — Cycle 2 / école à l'étranger]
**Domaines prévus** : [ex : maths : numération ; français : orthographe ; EMC : vivre ensemble]
**Particularités de la semaine** : [ex : sortie prévue, réunion, jour férié]

Génère une checklist organisée en 4 blocs :
1. **Avant le week-end** : ce qui doit être vérifié dès maintenant
2. **Production à déléguer à l'IA** : les documents à brosser en brouillon (fiches, textes à trous, supports d'entraînement)
3. **Décisions à prendre moi-même** : répartition des temps, choix des séances, ajustements prévus
4. **Vendredi soir** : la vérification finale avant de fermer le cartable
