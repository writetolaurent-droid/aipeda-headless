---
title: "Règlement de classe : l’IA prépare la trame, vous installez le climat"
...
<span class="prompt-label">📋 Projet de règlement en formulation positive</span>

Tu es un assistant qui aide un enseignant du primaire à rédiger un projet de règlement de classe en formulation positive.

**Cycle** : [ex : cycle 2, CE1]
**Valeurs de la classe** : [ex : respect, entraide, calme de travail — deux ou trois mots]

Génère un projet de règlement organisé par moments de la journée :
1. **Accueil et entrée en classe** : deux ou trois règles.
2. **Transitions et déplacements** : deux ou trois règles.
3. **Travaux de groupe** : deux ou trois règles.
4. **Moments collectifs** (écoute, restitution) : deux ou trois règles.
...
<div class="prompt-block">
<span class="prompt-label">📋 Version affiche et paragraphe familles</span>
...
**Règlement validé avec les élèves** : [coller les règles retenues]
**Cycle** : [ex : cycle 3, CM1]

Génère :
1. **La version affiche** : un texte ultra-court, un mot-clé mémorisable par règle (ex : « marcher », « écouter », « aider »), lisible d’un coup d’œil par un enfant.
2. **Le paragraphe familles** : cinq à huit lignes qui expliquent la démarche — des règles positives, organisées par moments de la journée, construites avec les élèves — sans jargon pédagogique, et qui invitent les parents à en parler à la maison.
...
<div class="prompt-block">
<span class="prompt-label">📋 Boîte à phrases de médiation</span>
...
**Cycle** : [ex : cycle 2]
**Moments visés** : [ex : rappels pendant les travaux de groupe, désaccords entre pairs]

Génère :
1. **Huit rappels positifs** : des phrases courtes pour recadrer sans humilier, qui rappellent le comportement attendu (ex : « On se déplace tranquillement », « J’écoute celui qui parle »).
2. **Six formules de résolution** : des amorces que les élèves emploient eux-mêmes pour exprimer un désaccord et chercher une solution (ex : « J’ai été gêné quand… », « Qu’est-ce qu’on peut faire, tous les deux ? »).
...
<div class="prompt-block">
<span class="prompt-label">📋 Amorces de débat sur le règlement</span>

Tu es un assistant qui prépare la révision collective d’un règlement de classe en atelier philo ou débat réglé.

**Cycle** : [ex : cycle 3]
**Règle(s) à discuter** : [coller une ou deux règles du règlement affiché]

Génère :
1. **Cinq amorces de questions** pour ouvrir la discussion : pourquoi cette règle existe, ce qu’elle protège, ce qui reste difficile à respecter et pourquoi.
2. **Deux relances** pour faire avancer l’échange sans trancher à la place des élèves.
3. **Une question de restitution** : comment recueillir la décision de la classe — garder, reformuler, compléter — et la noter sur le règlement affiché.
...
- 🔄 [Des rituels de classe efficaces avec l’IA](/article/rituels-classe-ia/) — les rituels qui portent le climat au quotidien.
