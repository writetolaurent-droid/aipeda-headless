---
title: "Situations-problèmes en maths et sciences : les construire avec l’IA"
...
1. **Vous choisissez et cadrenez** — la notion visée, l’obstacle à installer, le contexte réel de votre école
2. **L’IA génère** — des propositions d’énoncés ancrées dans ce contexte, paramétrables et déclinables
3. **Vous validez** — test du scénario, ajustement des variables, décision de lancer la recherche
...
C’est le complément naturel des exercices d’entraînement. Là, l’IA vous aide à produire des [exercices différenciés](/article/exercices-differencies-ia/) pour la phase d’application ; ici, elle construit le problème de recherche qui donne du sens à la notion avant l’entraînement. Les deux se succèdent dans une séquence, ils ne se remplacent pas.
...
<span class="prompt-label">📋 Prompt — De la notion au problème ouvert</span>
...
**Niveau** : [ex : CE2]
**Notion du programme** : [ex : le périmètre]
**Contexte de mon école** : [DÉCRIRE UN CADRE RÉEL : cour, jardin, cantine, matériel disponible, projet de classe en cours]

Propose :
1. **3 situations-problèmes différentes** : chacune part d’un problème concret que la notion permet de résoudre, formulé comme une question que les élèves peuvent se poser
2. **Pour chacune** : l’accroche (la mise en problème, en 2-3 phrases), la question de recherche, ce qui doit résister (pourquoi la réponse n’est pas immédiate), la notion qui en sort
3. **Interdit** : l’énoncé qui contient déjà la méthode, la question fermée à réponse unique immédiate, le décor sans lien avec la notion
...
<div class="prompt-block">
<span class="prompt-label">🏫 Prompt — Énoncé ancré dans le contexte réel</span>
...
**Mon contexte réel** :
[DÉCRIRE : environnement de l’école, lieux fréquentés par les élèves, projets en cours, contraintes matérielles]

Réécris l’énoncé pour que :
1. **Le décor soit le nôtre** : lieux, matériel et quantités renvoient à notre école ou à notre environnement proche
2. **Les données soient plausibles** : cohérentes avec le contexte décrit — marque par [À VÉRIFIER] toute valeur que je dois confirmer sur place
3. **La question reste ouverte** : l’ancrage ne doit pas transformer le problème en exercice guidé
4. **Le vocabulaire soit accessible** : adapté au niveau, sans jargon non travaillé
...
<div class="prompt-block">
<span class="prompt-label">🔀 Prompt — Déclinaison en 3 niveaux</span>
...
**Niveau** : [ex : CM1]
**Notion visée** : [ex : les fractions]

Génère :
1. **Niveau 1 — pour accéder** : mêmes enjeu et contexte, données plus simples ou plus concrètes, une étape de recherche à la fois
2. **Niveau 2 — le cœur du problème** : l’énoncé de référence, tel que validé
3. **Niveau 3 — pour prolonger** : une contrainte supplémentaire qui complexifie la recherche (condition ajoutée, généralisation, question inversée)
4. **Un contrôle final** : vérifie que les trois niveaux restent le MÊME problème — même question, même notion ; seule la profondeur de recherche change
...
<div class="prompt-block">
<span class="prompt-label">🔍 Prompt — Contrôle qualité avant séance</span>
...
**Niveau et notion** : [ex : CE1 — la monnaie]
**Effet recherché** : [ex : provoquer des essais de dénombrement, puis le besoin d’un outil pour s’y retrouver]

Vérifie et signale :
1. **Faisabilité** : les données sont-elles complètes et cohérentes ? Y a-t-il une information manquante ou contradictoire qui bloque la recherche ?
2. **Vraie question de recherche** : la réponse n’est-elle pas trop immédiate ? L’énoncé ne donne-t-il pas déjà la méthode ?
3. **Piège numérique** : ordres de grandeur irréalistes, calculs hors de portée du niveau, valeurs impossibles à manipuler en classe
4. **Ambiguïtés** : les tournures qui peuvent être comprises autrement que prévu
5. **Décor** : ce qui sonne artificiel ou plausible seulement en apparence
...
La place dans la séquence. La situation-problème ouvre la notion : elle crée le besoin, le problème dont la notion sera la solution. Les [exercices différenciés](/article/exercices-differencies-ia/) arrivent ensuite, pour la phase d’entraînement et d’application. L’IA sert les deux temps, avec des prompts différents — et les deux se succèdent dans une même séquence cohérente.
