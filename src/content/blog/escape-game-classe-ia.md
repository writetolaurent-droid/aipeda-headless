---
title: "Escape game pédagogique : créer une séance-jeu complète avec l’IA"
...
<span class="prompt-label">🎬 Prompt — Synopsis de l’escape game</span>
...
**Niveau** : [ex : CE2]
**Notions à réactiver** : [ex : les problèmes d’addition et de soustraction, la lecture de l’heure]
**Durée visée** : [ex : une séance d’une heure]
**Matériel disponible** : [ex : papier, enveloppes, cartes ; pas de cadenas ni d’écran]
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Énigmes liées aux programmes</span>
...
**Niveau** : [ex : CE2]
**Synopsis retenu** : [COLLER LE SYNOPSIS CHOISI ET VALIDÉ]
**Notions et attendus** : [RECOPIER LES FORMULATIONS DE VOS PROGRAMMES, UNE LIGNE PAR NOTION]
**Nombre d’énigmes** : [ex : 4, une par notion]
...
<div class="prompt-block">
<span class="prompt-label">💡 Prompt — Indices gradués pour chaque énigme</span>
...
**Niveau** : [ex : CE2]
**Énigmes** : [COLLER VOS ÉNIGMES VALIDÉES]
...
<div class="prompt-block">
<span class="prompt-label">🗣️ Prompt — Débriefing et trace de la séance</span>
...
**Niveau** : [ex : CE2]
**Notions révisées** : [VOTRE LISTE DE DÉPART]
**Synopsis** : [COLLER LE SCÉNARIO RETENU]
**Ce que j’ai observé** : [EX : des équipes qui ont bloqué sur la lecture des consignes de l’énigme 2 — à compléter après la séance]
