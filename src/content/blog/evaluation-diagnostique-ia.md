---
title: "Évaluation diagnostique avec l'IA : connaître sa classe dès les premiers jours"
...
<span class="prompt-label">📋 Prompt — Évaluation diagnostique de rentrée (français)</span>
...
**Durée visée** : [ex : 30 minutes, en plusieurs temps courts]
**Axes à sonder** :
1. **Langage oral** : compréhension de consignes, reformulation, vocabulaire courant
2. **Lecture** : correspondances graphème-phonème, compréhension d'un court texte lu seul
3. **Écriture** : copie soignée, phrase dictée simple, production autonome d'une phrase
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Deux variantes de difficulté pour une même compétence</span>
...
**Compétence observée** : [ex : résoudre un problème additif simple à une étape]
**Contexte des items** : [ex : situations du quotidien]
...
Piège classique : des variantes trop dissemblables, où l'objectif glisse et rend la comparaison inutile. Pour approfondir : [notre article sur les exercices différenciés](/article/exercices-differencies-ia/).
...
<div class="prompt-block">
<span class="prompt-label">📐 Prompt — Diagnostic mathématiques (nombres et calcul mental)</span>
...
**Niveau** : [ex : CP — Cycle 2]
**Contenus à sonder** : [ex : lire et écrire les nombres jusqu'à 69, comparer et encadrer, compléments à 10, petits problèmes dictés]
**Organisation souhaitée** : [ex : une partie écrite de 15 minutes + des questions orales posées en passation individuelle]

Génère :

1. **Partie écrite** : environ dix items progressifs, consigne en haut de chaque bloc, espace suffisant pour écrire
2. **Passation orale** : une dizaine de questions de calcul mental, avec la réponse attendue indiquée pour faciliter MON suivi pendant l'entretien
3. **Points de vigilance** : erreurs typiques de ce niveau sur ces contenus (confusion de position, stratégie tout-comptage, recomptage du premier terme), à croiser avec MES observations
...
<div class="prompt-block">
<span class="prompt-label">👀 Prompt — Grille d'observation qualitative (premiers ateliers)</span>
...
**Niveau** : [ex : GS — Cycle 1]
**Moment observé** : [ex : premiers ateliers de littératie]
**Dimensions à couvrir** : [ex : langage en petit groupe, geste d'écriture, engagement dans l'activité, appuis pour entrer dans la lecture]
...
Relisez-la à chaud, puis en fin de semaine : ce qui persiste aux deux lectures constitue de bons indicateurs. Pour aller plus loin : [notre guide des grilles d'évaluation avec l'IA](/article/grilles-evaluation-ia/).
...
- 📏 [Les évaluations repères CP et CE1 avec l'IA](/article/evaluations-reperes-cp-ce1-ia/) — les évaluations nationales de septembre : logistique et exploitation.
- 🏫 [Organiser ses APC avec l'IA](/article/apc-activites-pedagogiques-complementaires-ia/) — partir des résultats pour cibler les séances.
