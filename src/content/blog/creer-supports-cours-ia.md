...
Pour une vue d'ensemble de l'intégration de l'IA dans votre préparation, consultez le [guide complet pour préparer ses cours avec l'IA](/article/preparer-ses-cours-ia-guide-complet/).
...
<span class="prompt-label">📝 Prompt — Trace écrite</span>

Tu es un professeur des écoles expérimenté. Rédige la trace écrite pour une séance en [MATIÈRE] avec des élèves de [NIVEAU].

**Sujet précis** : [SUJET — ex : l'accord du pluriel des noms, le cycle de l'eau, la division euclidienne]
...
<div class="prompt-block">
<span class="prompt-label">📋 Prompt — Exercices progressifs</span>
...
**Sujet** : [SUJET PRÉCIS]
**Compétence visée** : [COMPÉTENCE — ex : identifier les fractions équivalentes]
...
Pour un prompt encore plus complet qui intègre trace écrite et exercices dans une même fiche, consultez le [prompt maître de création de fiche de cours](/article/prompt-chatgpt-fiche-de-cours/).
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Matériel de manipulation</span>
...
**Séance** : [SUJET PRÉCIS]
**Objectif de la phase de découverte** : [DÉCRIRE — ex : faire émerger la notion de fraction par le partage]
...
Pour enrichir une séquence existante avec de nouveaux supports, consultez notre guide sur l'[amélioration de séquence pédagogique avec l'IA](/article/ameliorer-sequence-pedagogique/).
...
<div class="prompt-block">
<span class="prompt-label">🧠 Prompt — Carte mentale</span>
...
**Ligne rouge IA et élèves** : aucun élève du primaire ou du collège ne doit dialoguer directement avec une IA. L'IA est un outil de préparation pour l'enseignant, jamais un outil en accès direct. Pour approfondir les usages côté enseignant, consultez le [guide pratique ChatGPT pour profs](/article/chatgpt-pour-prof/).
...
- 📘 [Préparer ses cours avec l'IA : le guide complet](/article/preparer-ses-cours-ia-guide-complet/) — La page pilier du cocon AIPEDA, avec 5 étapes complètes et 7 prompts
- ✏️ [Prompt ChatGPT : créer une fiche de cours en 2 min](/article/prompt-chatgpt-fiche-de-cours/) — Le prompt maître qui intègre trace écrite + exercices + manipulation + carte mentale dans une seule fiche
...
- 🎬 [Classe inversée au primaire : capsules et quiz avec l'IA](/article/classe-inversee-primaire-ia/) — Scripts et storyboards de capsules vidéo produits en première version
