---
title: "Dictées différenciées avec l’IA : un même texte, tous les niveaux"
...
<span class="prompt-label">📋 Prompt — Déclinaisons de dictée à partir du texte source</span>
...
**Texte source** :
[COLLER ICI UN EXTRAIT DU TEXTE LU EN CLASSE, 5 À 8 PHRASES]
...
<div class="prompt-block">
<span class="prompt-label">📋 Prompt — Banque de phrases courtes (mots de la semaine)</span>
...
**Niveau** : [ex : CE1]
**Mots de la semaine** : [lister les mots]
...
<div class="prompt-block">
<span class="prompt-label">📋 Prompt — Version aménagée pour élèves DYS</span>
...
<div class="prompt-block">
<span class="prompt-label">📋 Prompt — Dictée aménagée pour élève allophone (séquencement oral)</span>
