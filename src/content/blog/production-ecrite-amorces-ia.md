---
title: "Production d’écrits : amorces et critères de réussite avec l’IA"
...
<span class="prompt-label">📋 Prompt — Banque d’amorces déclenchantes</span>
...
**Niveau** : [ex : CE2 — cycle 2]
**Type d’écrit** : [ex : récit d’aventure au passé composé]
**Consigne de départ** : [ex : un personnage découvre une porte cachée]
**Nombre d’amorces** : [ex : 8]
...
<div class="prompt-block">
<span class="prompt-label">🚪 Prompt — Banque d’ouvertures pour un même sujet</span>
...
**Niveau** : [ex : CM1]
**Sujet imposé** : [ex : « le jour où j’ai retrouvé mon chien perdu »]
**Durée d’écriture** : [ex : 20 minutes]
...
<div class="prompt-block">
<span class="prompt-label">✅ Prompt — Critères de réussite progressifs par type d’écrit</span>

Tu es professeur des écoles. Aide-moi à formuler des critères de réussite progressifs pour une production d’écrits.

**Niveau** : [ex : CE1]
**Type d’écrit** : [ex : récit au passé / portrait / décrire un lieu / écrire un dialogue]
**Objectif de la séance** : [ex : utiliser correctement le passé composé dans un récit]
...
<div class="prompt-block">
<span class="prompt-label">🗒️ Prompt — Fiche d’auto-évaluation élève en langage clair</span>
...
<div class="prompt-block">
<span class="prompt-label">🧩 Prompt — Décliner un sujet en 3 niveaux de soutien</span>
...
**Sujet** : [ex : rédiger le dénouement d’un récit de mystère commencé en classe]
**Objectif** : [ex : utiliser les connecteurs temporels]
